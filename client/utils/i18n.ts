...
const translations: Record<Lang, Record<string, string>> = {
  th: {
    ...
    "auth.or_continue_with": "หรือ",
    "auth.continue_google": "เข้าสู่ระบบด้วย Google",
    "auth.continue_apple": "เข้าสู่ระบบด้วย Apple",
    "auth.social_error": "เข้าสู่ระบบไม่สำเร็จ กรุณาลองใหม่",
    ...
    "cat.free_cat_limit": "แผน Free เพิ่มได้สูงสุด {{limit}} ประเภท รายรับ+รายจ่าย\nอัปเกรด Premium เพื่อเพิ่มได้ไม่จำกัด",
    ...
    "acc.free_acc_limit": "แผน Free เพิ่มได้สูงสุด {{limit}} บัญชี\nอัปเกรด Premium เพื่อเพิ่มได้ไม่จำกัด",
    "acc.free_unlock": "แพลนฟรีใช้งานได้ {{limit}} บัญชี\nอัปเกรด Premium เพื่อปลดล็อคทุก account",
    "acc.currency_label": "สกุลเงิน / อัตราแลกเปลี่ยน",
    "acc.currency_other": "กำหนดเอง",
    "acc.currency_premium_hint": "Premium เท่านั้น — แตะเพื่ออัปเกรด",
    "acc.multi_currency_premium": "การตั้งสกุลเงินต่างประเทศต่อบัญชีเป็นฟีเจอร์ Premium\nอัปเกรดเพื่อใช้งาน multi-currency",
    "acc.exchange_rate_label": "อัตราแลกเปลี่ยน",
    ...
    "premium.monthly_price": "49/month",
    "premium.yearly": "รายปี",
    "premium.yearly_price": "199/year",
    "premium.yearly_discount": "ลด66%",
    "premium.restore": "Restore",
    "premium.error": "เกิดข้อผิดพลาด",
    "premium.subscribe": "สมัคร",
    "premium.current_plan": "แผนปัจจุบัน",
    "premium.free_plan": "Free",
    "premium.renews_on": "ต่ออายุ {{date}}",
    "premium.expires_on": "หมดอายุ {{date}}",
    "premium.free_limit_keyword": "จำกัด 1 คีย์เวิร์ด/หมวด และ บัญชี",
    "premium.free_limit_income": "จำกัด 1 ประเภท รายรับ",
    "premium.free_limit_expense": "จำกัด 5 ประเภท รายจ่าย",
    "premium.free_limit_account": "จำกัด 3 บัญชี",
    "premium.feat_keywords": "ไม่จำกัด คีย์เวิร์ด",
    "premium.feat_income_cat": "ไม่จำกัด ประเภทรายรับ",
    "premium.feat_expense_cat": "ไม่จำกัด ประเภทรายจ่าย",
    "premium.feat_accounts": "ไม่จำกัด จำนวนบัญชี",
    "premium.feat_currency": "กำหนดสกุลเงินต่อบัญชี",
    "premium.feat_ledger": "เพิ่มสมุดบัญชีที่ 2",
    "premium.feat_sync": "สำรอง & ซิงค์ข้ามอุปกรณ์",
    "premium.active_badge": "Premium ✓",
    "premium.active_desc": "คุณกำลังใช้แผน Premium",
  ...
  en: {
    ...
    "auth.social_error": "Sign-in failed, please try again",
    ...
    "acc.currency_label": "Currency / Exchange Rate",
    "acc.currency_other": "Custom",
    "acc.currency_premium_hint": "Premium only — tap to upgrade",
    "acc.multi_currency_premium": "Per-account foreign currency is a Premium feature.\nUpgrade to use multi-currency accounts.",
    "acc.exchange_rate_label": "Exchange Rate",
    ...
    "premium.yearly_price": "199/year",
    "premium.yearly_discount": "Save 66%",
    "premium.restore": "Restore",
    "premium.error": "An error occurred",
    "premium.subscribe": "Subscribe",
    "premium.current_plan": "Current Plan",
    "premium.free_plan": "Free",
    "premium.renews_on": "Renews {{date}}",
    "premium.expires_on": "Expires {{date}}",
    "premium.free_limit_keyword": "Max 1 keyword/category and account",
    "premium.free_limit_income": "Max 1 income category",
    "premium.free_limit_expense": "Max 5 expense categories",
    "premium.free_limit_account": "Max 3 accounts",
    "premium.feat_keywords": "Unlimited keywords",
    "premium.feat_income_cat": "Unlimited income categories",
    "premium.feat_expense_cat": "Unlimited expense categories",
    "premium.feat_accounts": "Unlimited accounts",
    "premium.feat_currency": "Assign account currency",
    "premium.feat_ledger": "Second ledger book",
    "premium.feat_sync": "Multi-device backup & sync",
    "premium.active_badge": "Premium ✓",
    "premium.active_desc": "You are on the Premium plan",
  ...
  zh: {
    ...
    "acc.currency_label": "币种 / 兑换率",
    "acc.currency_other": "自定义",
    "acc.currency_premium_hint": "仅限 Premium — 点击升级",
    "acc.multi_currency_premium": "每账户外币设置是 Premium 功能\n升级以使用多币种账户",
    "acc.exchange_rate_label": "兑换率",
    ...
    "premium.monthly": "月付",
    "premium.monthly_price": "49/月",
    "premium.yearly": "年付",
    "premium.yearly_price": "199/年",
    "premium.yearly_discount": "省66%",
    "premium.restore": "恢复购买",
    "premium.error": "发生错误",
    "premium.subscribe": "订阅",
    "premium.current_plan": "当前方案",
    "premium.free_plan": "免费版",
    "premium.renews_on": "续订 {{date}}",
    "premium.expires_on": "到期 {{date}}",
    "premium.free_limit_keyword": "每类别1个关键词",
    "premium.free_limit_income": "1个收入类别",
    "premium.free_limit_expense": "5个支出类别",
    "premium.free_limit_account": "3个账户",
    "premium.feat_keywords": "无限关键词",
    "premium.feat_income_cat": "无限收入类别",
    "premium.feat_expense_cat": "无限支出类别",
    "premium.feat_accounts": "无限账户",
    "premium.feat_currency": "为账户指定货币",
    "premium.feat_ledger": "添加第二本账本",
    "premium.feat_sync": "多设备备份与同步",
    "premium.active_badge": "Premium ✓",
    "premium.active_desc": "您正在使用Premium方案",
