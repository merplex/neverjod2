              ...
              <div className="grid grid-cols-6 gap-2">
                {categories.map((category) => (
                  <button
                    ...
                    className="py-2 px-1 bg-slate-100 hover:bg-indigo-200 text-slate-700 font-semibold rounded-lg transition-colors flex flex-col items-center gap-0.5 cursor-pointer text-xs"
                  >
                    <span className="font-bold">{category.name.slice(0, 3)}</span>
                  </button>
                ))}
              </div>
            </div>
              ...
              <div className="grid grid-cols-6 gap-2">
                {accounts.map((account) => (
                  <button
                    ...
                    className="py-2 px-1 bg-slate-100 hover:bg-indigo-200 text-slate-700 font-semibold rounded-lg transition-colors flex flex-col items-center gap-0.5 cursor-pointer text-xs"
                  >
                    <span className="font-bold">{account.name.slice(0, 3)}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <>
              ...
              >
                <div className="flex gap-4 items-center">
                  ...
                  <button className="flex-1 py-2 rounded-lg font-semibold text-sm bg-slate-100 text-slate-700 hover:bg-slate-200 transition-all">
                    Right
                  </button>
                </div>
              </div>
